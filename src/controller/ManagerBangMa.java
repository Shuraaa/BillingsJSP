...
public class ManagerBangMa extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "add":
			...
			BangMa bm = new BangMa(loaicuocgoi, ten, maquyuoc, chieudai, block1sfpt, block6sfpt, block10sfpt,
		...
		case "update":
			...
			block10scmc = Double.parseDouble(request.getParameter("block10scmc"));
			block1mcmc = Double.parseDouble(request.getParameter("block1mcmc"));
			BangMa bm1 = new BangMa(loaicuocgoi, ten, maquyuoc, chieudai, block1sfpt, block6sfpt, block10sfpt,
					block1mfpt, block1scmc, block6scmc, block10scmc, block1mcmc);
