...
public class LogCall {
	...
	public LogCall(int logID, String extensionID, String thueBaoNhan,
			int thoiGianGoi, double giaTien, String loaiCuocGoi,
	...
	public String toString() {
		return "LogCall [logID=" + logID + ", extensionID=" + extensionID
				+ ", thueBaoNhan=" + thueBaoNhan + ", thoiGianGoi="
				+ thoiGianGoi + ", giaTien=" + giaTien + ", loaiCuocGoi="
				+ loaiCuocGoi + ", nhaMangID=" + nhaMangID + ", maCuocGoi="
				+ maCuocGoi + "]";
	}
