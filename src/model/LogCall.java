...
public class LogCall {
	...
	public LogCall(String congTyID, String tenCongTy, String extensionID,
			...
			int thoiGianGoi, int thang, String loaiCuocGoi, double giaTien,
	...
	public String toString() {
		return "LogCall [congTyID=" + congTyID + ", tenCongTy=" + tenCongTy
				...
				+ tenPhongBan + ", thoiGianGoi=" + thoiGianGoi + ", thang="
				+ thang + ", loaiCuocGoi=" + loaiCuocGoi + ", giaTien="
				+ giaTien + ", thoiGianBatDau=" + thoiGianBatDau
