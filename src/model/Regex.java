...
public class Regex {
	...
	public Regex(String ten, String regex, double block1sFPT,
			double block6sFPT, double block10sFPT, double block1mFPT,
			double block1sCMC, double block6sCMC, double block10sCMC,
			double block1mCMC) {
		super();
		this.ten = ten;
		this.regex = regex;
	...
	public String toString() {
		return "Regex [ten=" + ten + ", regex=" + regex + ", block1sFPT="
				+ block1sFPT + ", block6sFPT=" + block6sFPT + ", block10sFPT="
				+ block10sFPT + ", block1mFPT=" + block1mFPT + ", block1sCMC="
				+ block1sCMC + ", block6sCMC=" + block6sCMC + ", block10sCMC="
				+ block10sCMC + ", block1mCMC=" + block1mCMC + "]";
	}
