...
public class Blocks {
	...
	public Blocks(String loaiCuocGoi, String nhaMangID, String maCuocGoi, double block1s, double block6s,
			double block10s, double blocks1m) {
		super();
	...
	public String toString() {
		return "Blocks [loaiCuocGoi=" + loaiCuocGoi + ", nhaMangID=" + nhaMangID + ", maCuocGoi=" + maCuocGoi
				+ ", block1s=" + block1s + ", block6s=" + block6s + ", block10s=" + block10s + ", blocks1m=" + blocks1m
				+ "]";
	}
}
