...
public class BangMa {
	...
	public BangMa(String loaiCuocGoi, String ten, String maQuyUoc,
			int chieuDai, double block1sFPT, double block6sFPT,
			double block10sFPT, double block1mFPT, double block1sCMC,
			double block6sCMC, double block10sCMC, double block1mCMC) {
	...
	public String toString() {
		return "BangMa [loaiCuocGoi=" + loaiCuocGoi + ", ten=" + ten
				+ ", maQuyUoc=" + maQuyUoc + ", chieuDai=" + chieuDai
				+ ", block1sFPT=" + block1sFPT + ", block6sFPT=" + block6sFPT
				+ ", block10sFPT=" + block10sFPT + ", block1mFPT=" + block1mFPT
				+ ", block1sCMC=" + block1sCMC + ", block6sCMC=" + block6sCMC
				+ ", block10sCMC=" + block10sCMC + ", block1mCMC=" + block1mCMC
				+ "]";
	}
