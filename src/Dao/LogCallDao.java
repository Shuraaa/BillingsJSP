...
public class LogCallDao {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 LogCall l2 = new LogCall("84285100", "0989490402", 10, "2016-04-01 08:36:39",
		 "2016-04-01 08:36:49","");
		 LogCall l3 = new LogCall("84285100", "0989490401", 10, "2016-04-01 08:36:39",
		 "2016-04-01 08:36:49","");
		 LogCall l4 = new LogCall("84285100", "0989490404", 10, "2016-04-01 08:36:39",
		 "2016-04-01 08:36:49","");
		 list.add(l1);
		 list.add(l2);
		 list.add(l3);
