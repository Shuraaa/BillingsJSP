...
//				String sql = "	insert into taikhoan_nguoidung (username,userpass,role,congtyID) values ('admin','123',1,'ct01');";
...
//				}
	...
	public static boolean addTaiKhoan(String userName, String userPass, int role,String congTyID) {
		try {
			Connection conn = DatabaseSQLConnection.getConnection();
			Statement stmt = conn.createStatement();
//			String sql = "insert into taikhoan_nguoidung values ('"+userName+"','"+userPass+"',"+role+",'"+congTyID+"');";
