...
<body>
	<%
		String exportToExcel = (String) request
				.getAttribute("exportToExcel");
	...
	%>
	<!-- Menu 3 -->
	<h3>Bảng cước điện thoại chi tiết công ty <%=tencongty %> tháng <%=thangnam %></h3>
	<h4>Cước nội hạt </h4>
	<div id="menu3" class="tab-pane fade">
		<!--Neu yeu cau gui ve là thong ke theo dich vu NOI HAT -->
		<%
			ArrayList<LogCall> listlogcall_dv = BillingDao.getListLogCall_DV(
					"A", idcongty, thangnam);
		%>
		<div>
				...
				<table align="left" border="2" id="datatable-responsive"
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td><%=(double) Math.round(((listlogcall_dv.get(i)
						.getGiaTien() + listlogcall_dv.get(i).getGiaTien()
						* tilemakeup) * 100) / 100)%></td>
						</tr>
						<%
							}
						%>
	...
	<div id="menu4" class="tab-pane fade">
		...
		<%
			ArrayList<LogCall> listlogcall_dv1 = BillingDao.getListLogCall_DV(
					"B", idcongty, thangnam);
		%>
		<div>
			<div class="box-body no-padding">
				<table align="left" border="2" id="datatable-responsive"
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td><%=(double) Math.round(((listlogcall_dv1.get(i)
						.getGiaTien() + listlogcall_dv1.get(i).getGiaTien()
						* tilemakeup) * 100) / 100)%></td>
						</tr>
						<%
							}
	...
	<div id="menu5" class="tab-pane fade">
		<!--Neu yeu cau gui ve là thong ke theo dich vu NOI HAT -->
		<%
			ArrayList<LogCall> listlogcall_dv2 = BillingDao.getListLogCall_DV(
					"C", idcongty, thangnam);
		%>
		<div>
			<div class="box-body no-padding">
				<table align="left" border="2" id="datatable-responsive"
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td><%=(double) Math.round(((listlogcall_dv2.get(i)
						.getGiaTien() + listlogcall_dv2.get(i).getGiaTien()
						* tilemakeup) * 100) / 100)%></td>
						</tr>
						<%
							}
	...
	<div id="menu6" class="tab-pane fade">
		<%
			ArrayList<LogCall> listlogcall_dv3 = BillingDao.getListLogCall_DV(
					"D", idcongty, thangnam);
		%>
		<div>
			<div class="box-body no-padding">
				<table align="left" border="2" id="datatable-responsive"
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td><%=(double) Math.round(((listlogcall_dv3.get(i)
						.getGiaTien() + listlogcall_dv3.get(i).getGiaTien()
						* tilemakeup) * 100) / 100)%></td>
						</tr>
						<%
							}
	...
	<div id="menu7" class="tab-pane fade">
		<%
			ArrayList<LogCall> listlogcall_dv4 = BillingDao.getListLogCall_DV(
					"E", idcongty, thangnam);
		%>
		<div>
			<div class="box-body no-padding">
				<table align="left" border="2" id="datatable-responsive"
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td><%=(double) Math.round(((listlogcall_dv4.get(i)
						.getGiaTien() + listlogcall_dv4.get(i).getGiaTien()
						* tilemakeup) * 100) / 100)%></td>
						</tr>
						<%
							}
	...
	%>
	<a
		href="<%=request.getContextPath()%>/ManagerBilling?command=exportPDFdetail&congtyid=<%=idcongty%>&tencongty=<%=tencongty%>&thangnam=<%=thangnam%>&exportToExcel=YES">Export
		to Excel</a>
	<%
		}
	%>
