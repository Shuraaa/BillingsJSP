							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="tenRegex"
											placeholder="Regex Name" id="regexName" maxlength="80">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="input_Ma" class="col-sm-2 control-label">Chuỗi
										Regex: </label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="chuoiString"
								...
								<!-- Form group -->
								<div class="form-group">
									<label for="inputKind" class="col-sm-2 control-label">Loại:
									</label>
									<div class="col-sm-5">
										<select class="form-control" name="loaiRegex">
											<option value="regexnoihat">Nội hạt</option>
											<option value="regexdidong">Di động</option>
											<option value="regexlientinh">Liên tỉnh</option>
											<option value="regexquocte">Quốc tế</option>
											<option value="regexdichvu">Dịch vụ</option>
										</select>
									</div>
								</div>
									...
									.validate(
											{
												...
												messages : {
													tenRegex : "Vui lòng điền đầy đủ thông tin",
													chuoiString : "Nhập vào chuỗi Regular Expression",
													block1sfpt : {
