							...
							<div class="box-body">
								<div class="row">
									...
									<div class="col-sm-3">
										<input type="hidden" name="congtyid" value="<%=idcongty%>"></input>
										<input type="hidden" name="tencongty" value="<%=tencongty%>"></input>
										<input type="hidden" name="yc" value="<%=yeucau%>"></input>
										<input type="hidden" name="command" value="filter_thangnam"></input>
										<button type="submit"
											class="btn btn-primary glyphicon glyphicon-search">
										</button>
									</div>
												...
												<%
													double tongcuocchuavat1 = tiennoihat + tienlientinh + tiendidong + tienquocte + tiendichvu;
														...
														double tongcuocmakeup = (double) Math.round((tongcuocchuavat + tongcuocchuavat * tilemakeup) * 100)
																/ 100;
														double thanhtien = (double) Math.round((tongcuocmakeup + 20000) * 100)
																/ 100;;
										...
										<table id="datatable-responsive"
											...
											<tbody>
												...
												<tr class="gradeA">
													...
													<td><%=(double) Math.round(((listlogcall_dv.get(i).getGiaTien()* (1+tilemakeup))* 100) / 100)%></td>
												</tr>
												<%
													}
														}
								...
								((listexten_pb.get(i).getGiaTien() + listexten_pb.get(i).getGiaTien() * tilemakeup)
										* 100) / 100)%></td>
												...
												<tr class="gradeA">
													...
													<td><%=(double) Math.round(((listlogcall_ex.get(i).getGiaTien() + listlogcall_ex.get(i).getGiaTien() * tilemakeup)
										* 100) / 100)%></td>
												</tr>
												<%
													}
