								...
								<tbody>
									...
									if (congtyid != null){%>
												...
												<tr class="gradeA">
													...
													<input type="hidden" name="congtyid" value=<%=congtyid%>></input>
													<%
													...
													<td>
														...
														%> &nbsp;&nbsp; <a
														href="<%=request.getContextPath()%>/ManagerPhongBan?command=delete&phongbanid=<%=listPhongBanCT.get(i).getPhongBanID()%>&congtyid=<%=congtyid%>"><button
																type="button"
									...
									<%
											...
											<tr class="gradeA">
												...
												<td><input type="text" class="form-control"
													name="txt_tenphongban" placeholder="Group name"
													value="<%=listPhongBan.get(i).getTenPhongBan()%>"></input></td>
												<input type="hidden" name="txt_idphongban"
													value="<%=listPhongBan.get(i).getPhongBanID()%>"></input>
												<input type="hidden" name="command" value="update"></input>
												<%
													} else {
												%>
