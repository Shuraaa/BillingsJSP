...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%
		if (session.getAttribute("username") == null) {
			...
			String regexString = (String) request.getAttribute("regexString");
			String tenbang = (String) request.getAttribute("tenbang");
			Regex bm =RegexDao.getRegex(regexString, tenbang);
	%>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="admin_regex.jsp">Regular expression</a></li>
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="box box-primary">
						...
						<form action="<%=request.getContextPath()%>/ManagerRegex"
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="tenRegex"
											placeholder="Name" id="regexName" value="<%=bm.getTen()%>">
									</div>
								</div>

								<!-- Form group -->
								<div class="form-group">
									<label for="input_Ma" class="col-sm-2 control-label">Chuỗi
										Regex: </label>
									<div class="col-sm-5">
										<input type="text" class="form-control" name="regexString"
											placeholder="String" id="regexString"
											value="<%=bm.getRegex()%>">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-9 text-center">
										...
										<div class="col-sm-4">FPT</div>
										<div class="col-sm-3">CMC</div>
									</div>
								</div>
							...
							<input type="hidden" name="tenbang" value="<%=tenbang%>"></input>				
