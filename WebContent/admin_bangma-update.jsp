...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%
		if (session.getAttribute("username") == null) {
			...
			// lay du lieu dien vào form edit de update
			String maquyuoc = (String)request.getAttribute("maquyuoc");
			String cd = (String) request.getAttribute("chieudai");
			int chieudai = Integer.parseInt(cd);
			BangMa bm = BangMaDao.getBangMa(maquyuoc, chieudai);
				...
				<div class="col-sm-12">
					...
					<div class="box box-primary">
						...
						<form action="<%=request.getContextPath()%>/ManagerBangMa" method="get" role="form" class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="ten"
											placeholder="Name" id="codename" maxlength="30" value="<%=bm.getTen() %>" disabled>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="maquyuoc"
											placeholder="Code" id="code" maxlength="30"  value="<%=bm.getMaQuyUoc() %>" disabled>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="chieudai"
											placeholder="Length" id="length" maxlength="3" value="<%=bm.getChieuDai() %>" disabled>
									</div>
								</div>
									...
									<div class="col-sm-6">
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block1sfpt"
												placeholder="FPT" id="block1sfpt" maxlength="30" value="<%=bm.getBlock1sFPT() %>">
										</div>
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block1scmc"
												placeholder="CMC" id="block1scmc" maxlength="30" value="<%=bm.getBlock1sCMC() %>">
										</div>
									</div>
								</div>
									...
									<div class="col-sm-6">
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block6sfpt"
												placeholder="FPT" id="block6sfpt" maxlength="30" value="<%=bm.getBlock6sFPT() %>">
										</div>
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block6scmc"
												placeholder="CMC" id="block6s" maxlength="30" value="<%=bm.getBlock6sCMC() %>">
										</div>
									</div>
								</div>
									...
									<div class="col-sm-6">
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block10sfpt"
												placeholder="FPT" id="block10sfpt" maxlength="30" value="<%=bm.getBlock10sFPT() %>">
										</div>
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block10scmc"
												placeholder="CMC" id="block10scmc" maxlength="30" value="<%=bm.getBlock10sCMC() %>">
										</div>
									</div>
								</div>
									...
									<div class="col-sm-6">
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block1mfpt"
												placeholder="FPT" id="block1mfpt" maxlength="30" value="<%=bm.getBlock1mFPT() %>">
										</div>
										<div class="col-sm-5">
											<input type="text" class="form-control" name="block1mcmc"
												placeholder="CMC" id="block1mcmc" maxlength="30" value="<%=bm.getBlock1mCMC() %>">
										</div>
									</div>
								</div>
							...
							<input type="hidden" name="ten1" value="<%=bm.getTen()%>"></input>
							<input type="hidden" name="maquyuoc1" value="<%=bm.getMaQuyUoc()%>"></input>
							<input type="hidden" name="chieudai1" value="<%=bm.getChieuDai()%>"></input>
							<input type="hidden" name="loaicuocgoi1" value="<%=bm.getLoaiCuocGoi()%>"></input>
