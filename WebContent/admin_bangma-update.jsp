			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="box box-primary">
						...
						<form action="<%=request.getContextPath()%>/ManagerBangMa"
							...
							<input type="hidden" name="command" value="update"></input> <input
								type="hidden" name="ten1" value="<%=bm.getTen()%>"></input> <input
								type="hidden" name="maquyuoc1" value="<%=bm.getMaQuyUoc()%>"></input>
							<input type="hidden" name="chieudai1"
								value="<%=bm.getChieuDai()%>"></input> <input type="hidden"
								name="loaicuocgoi1" value="<%=bm.getLoaiCuocGoi()%>"></input>
